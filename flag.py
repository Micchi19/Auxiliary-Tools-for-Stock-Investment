...
def term_1(moving_average5, moving_average25):
    flag_1st = True
    for i in range(5):
...
def term_2(moving_average5, candlestick_25, row_25):
    cnt = 0
    for i in range(5):
        cnt = cnt + \
...
def term_3(moving_average25, moving_average5, data_60m):
...
#           後者だとすると、判別するの難しいな
def term_4(moving_average25, moving_average5):
